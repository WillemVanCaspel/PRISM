...
file_n_1 = 'test58.dat'
file_n_2 = 'test25.dat' # 25 originally
var  = 'u'
var2 = 'u'
...
im = ax1.contourf(sd_time,altitudes,tot_sd_s2[:,:,0].T,np.arange(smin2,50.05,0.1),vmin=plot_min,vmax=plot_max,cmap=cm)
cs = ax1.contour(sd_time,altitudes,tot_sd_s2[:,:,0].T, np.arange(smin,smax,nstep),linewidths=linefs,colors='black')
ax1.clabel(cs, np.arange(smin,smax,nstep)[::contour_step], inline=1, fontsize=l_fs,fmt='%1.0f',colors=lab_c)
...
ax4.contourf(sd_time,altitudes,tot_sd_m2[:,:,0].T,nlvelsmooth,vmin=plot_min2,vmax=plot_max2,cmap=cm2)
cs = ax4.contour(sd_time,altitudes,tot_sd_m2[:,:,0].T,np.arange(smin,smax2,nstep2),linewidths=linefs,colors='black')
ax4.clabel(cs, np.arange(smin,smax2,nstep2)[::contour_step], inline=1, fontsize=l_fs,fmt='%1.0f',colors=lab_c)
...
ax2.contourf(na_time,height_arr / 1000,tot_na_s2[:,:,0].T,nlvelsmooth,vmin=plot_min,vmax=plot_max,cmap=cm)
cs = ax2.contour(na_time,height_arr / 1000,tot_na_s2[:,:,0].T,np.arange(smin,smax,nstep),linewidths=linefs,colors='black')
ax2.clabel(cs, np.arange(smin,smax,nstep)[::contour_step], inline=1, fontsize=l_fs,fmt='%1.0f',colors=lab_c)
...
im2 = ax5.contourf(na_time,height_arr / 1000,tot_na_m2[:,:,0].T,np.arange(smin2,32.05,0.1),vmin=plot_min2,vmax=plot_max2,cmap=cm2)
cs = ax5.contour(na_time,height_arr / 1000,tot_na_m2[:,:,0].T,np.arange(smin,smax2,nstep2),linewidths=linefs,colors='black')
ax5.clabel(cs, np.arange(smin,smax2,nstep2)[::contour_step], inline=1, fontsize=l_fs,fmt='%1.0f',colors=lab_c)
...
cb.ax.tick_params(labelsize=ts + 2)
cb.set_ticks(np.arange(smin2,smax2 + 1,nstep2))

ax3.contourf(na_time,height_arr / 1000,tot_na_s22[:,:,0].T,nlvelsmooth,vmin=plot_min,vmax=plot_max,cmap=cm)
cs = ax3.contour(na_time,height_arr / 1000,tot_na_s22[:,:,0].T,np.arange(smin,smax,nstep),linewidths=linefs,colors='black')
ax3.clabel(cs, np.arange(smin,smax,nstep)[::contour_step], inline=1, fontsize=l_fs,fmt='%1.0f',colors=lab_c)
ax3.set_ylim(zmin,zmax)
ax3.set_xlim(tmin,tmax)
ax3.tick_params(axis='x', which='major', labelsize=ts)
ax3.tick_params(axis='y', which='major', labelsize=ts)
...
ax6.contourf(na_time,height_arr / 1000,tot_na_m22[:,:,0].T,nlvelsmooth,vmin=plot_min2,vmax=plot_max2,cmap=cm2)
cs = ax6.contour(na_time,height_arr / 1000,tot_na_m22[:,:,0].T,np.arange(smin,smax2,nstep2),linewidths=linefs,colors='black')
ax6.clabel(cs, np.arange(smin,smax2,nstep2)[::contour_step], inline=1, fontsize=l_fs,fmt='%1.0f',colors=lab_c)
...
# plt.savefig(save_f + 's2m2_CMOR_HR.png',dpi=300, bbox_inches="tight")
