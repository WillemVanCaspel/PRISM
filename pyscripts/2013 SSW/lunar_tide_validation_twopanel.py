...
ax1.set_title(r'Jan migrating lunar SDT Amp (ms$^{-1}$) in U',fontsize=title_fs)
...
ax3.set_title(r'Jul migrating lunar SDT Amp (ms$^{-1}$) in U',fontsize=title_fs)
...
# plt.savefig(save_f + 'lunar_validation_2panel.png',dpi=300,bbox_inches="tight")
