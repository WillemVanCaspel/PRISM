...
file_n_1 = 'test25.dat' # 58 normally for PRISM simulation
var = 'u'
var2 = 'u'
...
ax2.text(16.5,97.5,'(c)',fontsize=fs + 7,fontweight=fw)

ax4.text(16.5,97.5,'(b)',fontsize=fs + 7,fontweight=fw)
ax5.text(16.5,97.5,'(d)',fontsize=fs + 7,fontweight=fw)

cbar_ax = fig.add_axes([2.45, 0.65, 0.04, 1.15])
...
cbar_ax = fig.add_axes([1.05, 0.65, 0.04, 1.15])
...
# plt.savefig(save_f + 's2m2_CMOR.png',dpi=300, bbox_inches="tight")

#%%

folder = '/home/wim/Desktop/Thesis/data/ssw_meteor_rad/'
np.save(folder + 'cmo_solar_contam.npy',tot_na_s2[:,:,0])
np.save(folder + 'cmo_lunar_contam.npy',tot_na_m2[:,:,0])

np.save(folder + 'cont_time.npy',na_time)
np.save(folder + 'cont_height.npy',height_arr)
