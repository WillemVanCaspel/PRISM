...
full_v_2 = np.load(save_f + file_n_1 + '_u.npy')[:,:,:,:] 
height_min = 0
height_max = 100
...
ax1.set_title(name + ' SW2 at ' + "{:.0f}".format(altitudes[0] / 1000) + ' km in U',fontsize=fs)
...
ax2.set_title(name + ' SW1 at ' + "{:.0f}".format(altitudes[0] / 1000) + ' km in U',fontsize=fs)
...
ax3.set_title(name + ' SW3 at ' + "{:.0f}".format(altitudes[0] / 1000) + ' km in U',fontsize=fs)
...
# plt.savefig(save_f + 'FA_sw1_sw2_sw3.png',dpi=300, bbox_inches="tight")
