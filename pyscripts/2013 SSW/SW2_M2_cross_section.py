...
ax1 = fig.add_axes([0.0, 1.30, 1.0, 0.6]) # [xmin, ymin, dx, dy]
ax2 = fig.add_axes([0.0, 0.525, 1.0, 0.6]) 
...
ax1.set_title(r'OnlyThermal SW2 at 60$^{\circ}$N in U',fontsize=fs)
...
ax1.text(17.5,132.5,'(a)',fontsize=fs + 4,fontweight=fw)
ax2.text(17.5,132.5,'(b)',fontsize=fs + 4,fontweight=fw)

save_f = '/home/wim/Desktop/Projects/iSSW/paper/figures/'
# plt.savefig(save_f + 'sw2_m2_cross_section.png',dpi=300, bbox_inches="tight")
