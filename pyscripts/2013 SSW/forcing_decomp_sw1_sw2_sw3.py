...
im = ax1.contourf(dt,lats,amps3[:,0,::1,wave1_ind].T,np.arange(smin,smax,nstep),vmin=0,vmax=plot_max,cmap=cm)
cs = ax1.contour(dt,lats,amps3[:,0,::1,wave1_ind].T, np.arange(smin,smax,nstep),linewidths=linefs,colors='black')
...
im2 = ax2.contourf(dt,lats,amps3[:,0,::1,wave2_ind].T,np.arange(smin,smax2,nstep2),vmin=0,vmax=plot_max2,cmap=cm)
cs = ax2.contour(dt,lats,amps3[:,0,::1,wave2_ind].T, np.arange(smin,smax2,nstep2),linewidths=linefs,colors='black')
...
im3 = ax3.contourf(dt,lats,amps3[:,0,::1,wave3_ind].T,np.arange(smin,smax3,nstep3),vmin=0,vmax=plot_max3,cmap=cm)
cs = ax3.contour(dt,lats,amps3[:,0,::1,wave3_ind].T, np.arange(smin,smax3,nstep3),linewidths=linefs,colors='black')
...
# plt.savefig(save_f + 'fixedatmos_sw1_sw2_sw3.png',dpi=300, bbox_inches="tight")
